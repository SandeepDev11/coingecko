          ...
          <div className="learnBg p-4 rounded-3">
            <Row>
              <div className="col-lg-6">
                <h4 className="fw-semibold">Learn Cryptocurrency with ProCoinMaster</h4>
                <p className="mb-0">
                  Start with beginner friendly guides and the basics of cryptocurrency. Progress at your own pace and learn everything you need to know around it.
                </p>
              </div>
            </Row>
          </div>
      ...
      <section className="featured-articles-wrapper py-4">
        <Container>
          ...
          <div className="articles-wrappper">
            <Row>
              <Col lg={6}><MainArticleCard article={mainArticle} /></Col>
              <Col lg={6}><SideArticlesList articles={sideArticles} /></Col>
            </Row>
          </div>
        </Container>
        ...
        <Container className="py-2">
          <div className="d-flex justify-content-between align-items-center">
            <h2 className="fw-bold fs-4">Latest Articles</h2>
            <Link to="/learn">
          ...
          <div className="articles-wrappper">
            <Row className="h-100">
              <Col lg={4} sm={12}><MainArticleCard article={mainArticle} /></Col>
              <Col lg={4} sm={12}><SideArticlesList articles={sideArticles} /></Col>
              <Col lg={4} sm={12}><SideArticlesList articles={sideArticles} /></Col>
            </Row>
          </div>
        </Container>
