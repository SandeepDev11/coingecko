          ...
          <div className="learnBg p-4 rounded-3">
            <Row>
              <div className="col-lg-6">
                <h4 className="fw-semibold">Guides</h4>
                <p className="mb-0">
                Navigate the crypto world with our selection of guides that cover everything from the fundamentals to the latest trends.
                </p>
              </div>
            </Row>
          </div>
