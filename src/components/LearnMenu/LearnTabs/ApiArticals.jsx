...
import articalImg from "../../../assets/Images/letastArticals‫Img.webp";
          ...
          <div className="learnBg p-4 rounded-3">
            <Row>
              <div className="col-lg-6">
                <h4 className="fw-semibold">API</h4>
                <p className="mb-0">
                Read our practical guides and resources and learn how to use CoinGecko API for all use-cases and projects.
                </p>
              </div>
            </Row>
          </div>
